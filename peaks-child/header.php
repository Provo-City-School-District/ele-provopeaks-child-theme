...
<html <?php language_attributes();?>>
	<head>
		<!-- Global site tag (gtag.js) - Google Analytics -->
			<script async src="https://www.googletagmanager.com/gtag/js?id=UA-130781213-10"></script>
			<script>
			  window.dataLayer = window.dataLayer || [];
			  function gtag(){dataLayer.push(arguments);}
			  gtag('js', new Date());
			
			  gtag('config', 'UA-130781213-10');
			</script>
	...
	<body>
		...
		<header id="mainHeader">
			...
			<h1>Provo Peaks Elementary School</h1>
			</a>
				<aside>
					<ul class="sociallinks">
						...
						<li><a href="https://www.facebook.com/Provo-Peaks-Elementary-1651227231800872/"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-facebook-white.svg' ?>" alt="Link to Facebook" /></span>
							</a>
						</li>
					</ul>
					<!-- Search Form -->
					...
					<ul class="contactinfo" itemscope itemtype="https://schema.org/PostalAddress">
						<li><span itemprop="streetAddress">665 East Center</span><span itemprop="addressLocality"> Provo</span>, <span itemprop="addressRegion">Utah</span> <span itemprop="postalCode">84606</span><span class="phone" itemprop="telephone"> Phone: (801) 374-4940</span><span class="fax" itemprop="faxNumber"> Fax: (801) 374-4982</span>
					</ul>
